"""
Encode the DP prior using PriorCVAE model
"""
...
@hydra.main(version_base="1.2", config_path="configs/", config_name="dp_experiment")
def run_experiment(cfg: DictConfig):
    ...
    # Data generator
    x = create_grid(n_data=cfg.n_data, lim_low=cfg.x0, lim_high=cfg.x1, dim=1).reshape((1, -1))  # (B, N)
    x_init = jnp.array([cfg.x_init], dtype=x.dtype).reshape((1, 1))
    data_generator = instantiate(cfg.data_generator)(t=x, x_init=x_init)
